            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseThree" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item active" href="add_patient.jsp">Add Patient</a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="patient_ic">IC No</label>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="patientBD">Birth Date</label>
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="patientAddres">Address</label>
                            ...
                            <button type="submit" class="btn btn-primary mt-5 ml-2">Add Patient</button>
                        </div>
                        </form>
                    </div>
                    <!-- /.container-fluid -->
