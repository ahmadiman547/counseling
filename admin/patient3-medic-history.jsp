...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin-Patient 3-Medical History</title>
    ...
    <body id="page-top">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-auto">
                                <!-- Page Heading -->
                                <h1 class="h3 mb-2 text-gray-800">Harry Potter - Medical History</h1>
                            </div>
                            <div class="col-auto">
                                <!-- Button trigger add-app page -->
                                <a class="btn btn-primary" href="manage_patient.jsp" role="button">Go Back</a>
                            </div>
                            <div class="col-auto">
                                <!-- Button trigger add-app page -->
                        ...
                        <form action="#">
                            <table class="table">
                                <tr>
                                    ...
                                    <td><input type="text" id="illness" name="illness"></td>
                                </tr>
                                <tr>
                                    <td>Duration: </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="med_detail" name="med_detail">
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="editTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example2ModalLongTitle">Edit Record</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
