        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapsePatient" class="collapse show" aria-labelledby="headingPatient" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item active" href="add-patient.jsp">Add Patient</a>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="patient_ic" name="ic" placeholder="000000-00-0000">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="custom-select mr-sm-2" id="patient_gender-gender">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="patient_phone" name="phone" placeholder="010-100100">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputDesc">Address</label>
                                        <textarea id="address" class="form-control" name="address" rows="4" cols="50">
                                            
                                        </textarea>
                                    </div>
                                    <input type="hidden" id="addpatient" value="TBD">
                                </div>
                                <button type="submit" class="btn btn-primary mt-5">Add Patient</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.container-fluid -->
