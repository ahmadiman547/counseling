...
<html lang="en">
    ...
    <head>
        ...
        <title>Counselor - Edit Profile</title>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePatient" class="collapse" aria-labelledby="headingPatient" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="view-patient.jsp">View Patient</a>
                        </div>
                    </div>
                </li>
                                ...
                                <form>
                                    <div class="form-row">
                                      <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="edit-firstName" placeholder="Dennis ">
                                      </div>
                                      <div class="form-group col-md-6">
                                        <label for="edit-lastName">Last Name</label>
                                        <input type="text" class="form-control" id="edit-lastName" placeholder="Ritchie">
                                      </div>
                                    </div>
                                    <div class="form-row">
                                      <div class="form-group col-auto">
                                        <label for="edit-ICNum">IC Number</label>
                                        <input type="text" class="form-control" id="edit-ICNum" placeholder="011010-14-1848">
                                      </div>
                                      <div class="form-group col-auto">
                                        <label for="edit-DOB">Date of Birth</label>
                                        <input type="text" class="form-control" id="edit-DOB" placeholder="10/10/2001">
                                      </div>
                                    ...
                                    <div class="form-row">
                                      <div class="form-group col-md-6">
                                        ...
                                        <input type="email" class="form-control" id="edit-email" placeholder="unknownworld24@gmail.com">
                                      </div>
                                      <div class="form-group col-md-6">
