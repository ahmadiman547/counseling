...
<html lang="en">
    ...
    <head>
        ...
        <title>Counselor - Add Appointment</title>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="inputPatient" class="form-control">
                                            <option selected>Choose one</option>
                                            <option value="1">Richard Nixon</option>
                                            <option value="2">Betelguese Contee</option>
                                            <option value="3">Regulus Corneas</option>
                                        </select>
                                    </div>
                                    ...
                                    <input type="hidden" id="apmRoom" value="TBD">
                                </div>
